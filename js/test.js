/*    this.startButton = this.game.add.button(480, 300, 'button', startGame, this, 1, 0, 2);
    this.startButton.anchor.set(0.5);
	this.startButton.input.useHandCursor = true;
//this.endButton = this.game.add.button(300, 15, 'button', endGame, this, 1, 0, 2);
  //  this.startButton.anchor.set(0.5);

	};
PlayState.endGame = function() {
 ...
 PlayState.StartGame = function() {
	...
	//create end gamebutton
 PlayState.endButton = (function(){
  var button = game.add.button(400, 15, 'endButton',level:0, this, 2, 0, 1);
...
// =============================================================================
    ...
    var game = new Phaser.Game(960, 600, Phaser.AUTO, null ,{preload , create , update});
	var playing = true;
	const LEVEL_COUNT = 2;
	var startButton;
	function preload() {
	...
	this.game.load.spritesheet('button', 'images/button.png');
